...
As a high-level language, JAVA is much easier, as long as you focus on thinking about the algorithm. The underlying logic can be ignored. In my [JAVA calculator project](https://github.com/roboterz/CISC3160/tree/main/Lab4/Calculator), to create a GUI interface, the java swing components can be realized.
