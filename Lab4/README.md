...
Later, the central processing unit had a floating-point unit. As the machine is different, we need to modify the corresponding assembly statement. Example of division using floating point operations: [complete code](https://github.com/roboterz/CISC3160/blob/main/Lab4/Lab4_4_float.asm)
'''
# Calculate BMI
